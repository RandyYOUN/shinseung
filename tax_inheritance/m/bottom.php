	...
	<section class="customer">
			<a href="javascript:go_kakao();" class='IfdoVirtualPage' data-url='chat_request.html' data-title='채팅상담 요청'><span>채팅상담</span><span>쉽고 빠른 상담! 자료 전송까지 OK! </span></a>
			<div>
				<h1>전화상담</h1>
				...
				<h3>1899-9533</h3>
				<a class="call" href="tel:1899-9533" class='IfdoVirtualPage' data-url='tel_request.html' data-title='전화상담 요청'>전화걸기</a>
			</div>
		</section>
	...
	<div class="mgnb">
		<a href="index.php">
			<h1><img src="resources/images/logo.png"><span class="logotitle">상속세 제휴상담센터</span></h1>
		</a>
		<ul>
			<li>
