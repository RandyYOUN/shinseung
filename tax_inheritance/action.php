...
{ 
	...
	{ 
		...
		BEGIN
		INSERT INTO NEW_HP(NEW_HP,Q_TYPE,REGDATE,GUBUN) VALUES(NEW_HP,Q_TYPE,NOW(),'상속세');
		END
		";
		...
		{ //위에서 만든 프로시저 실행
			if(mysqli_query($connect,$procedure))
			{
				...
				$_param['msg'] = '상속세 사이트에서 '.$NEW_HP.' 번호로 '.$Q_TYPE. '전화상담 문의가 왔습니다. 응대부탁드립니다.';
				$_param['subject'] = '응대요청';
...
전화상담 가능시간 : 평일 오전 10시 ~ 오후 6시';
					break;
					case "상속" : echo '성공적으로 전화상담 요청이 신청되었습니다. 
조금만 기다려주시면 빠르고 전문적인 전화상담이 가능합니다. 
전화상담 가능시간 : 평일 오전 10시 ~ 오후 6시';
					break;
