	...
	<section class="customer">
			<a href="javascript:go_kakao();"><span>채팅상담</span><span>쉽고 빠른 상담! 자료 전송까지 OK! </span></a>
			<div>
				<h1>전화상담</h1>
	...
	<div class="mgnb">
		<a href="index.php">
			<h1><img src="resources/images/logo.png"><span class="logotitle">증여세 전문상담센터</span></h1>
		</a>
		<ul>
			<li>
