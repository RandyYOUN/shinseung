					...
					<table>
						<tbody>
							...
							<tr>
								...
								<th><span>사업자번호</span></td>
								<td>
									<input type="box" class="w10" name="BIZ_ID1" id="BIZ_ID1"><i>-</i><input type="box" class="w15" name="BIZ_ID2" id="BIZ_ID2"><i>-</i><input type="box" class="w10" name="BIZ_ID3" id="BIZ_ID3">
								</td>
							</tr>
							<tr>
								<td rowspan="4">
