...
<div>
	...
	<span style="font-size:20px;">
		<a href="http://taxtok.kr/admin/list_cal.php">&nbsp;<B>[조정료계산]</B>&nbsp;</a>
	</span>
	<span >
...
<label style="font-size:30px;"><input type="radio" name="rd_ADD" id="rd_ADD" value="0.3" style="width:50px;height:20px;font-size:30px;">30%</label>&nbsp;&nbsp;&nbsp;
