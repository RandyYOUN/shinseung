...
$result = @mysql_query("SELECT *, date_format(NEWS_REGDATE,'%d') as reg_dd, left( date_format(NEWS_REGDATE,'%m'),3) as reg_MM , (CASE WHEN IFNULL(IMG_URL ,'') = '' THEN 'http://sostax.kr/y2509g/news/images/tax.png' ELSE IMG_URL END ) AS IMG_URL_ , CATE FROM SS_NEWS where ID = $id ORDER BY ID DESC;") or die("SQL error");
...
<!-- Page Header -->
	...
	<!-- Blog single content -->
	<div class="conWrap">
		<section id="main-content" class="container no-padding con">
			<div class="row">
				<div class="col-md-12">
				<!-- Blog content -->
					<div class="col-md-10 blog-post" style="float:none; margin:0 auto";>
						<article>
							<header>
								<div class="post-date"><em><?php echo $row["reg_MM"] ?>.<?php echo $row["reg_dd"] ?></em></div>
	...
	<div class="locationWrap">
		<h3>신승세무법인 지점안내</h3>
		<h4>쉽고빠른 세무상담 / 증빙자료 전송가능</h4>
		<section class="location">			
			<div>
				<h1>신승세무법인 지점안내</h1>
				<h2>쉽고빠른 세무상담 / 증빙자료 전송가능</h2>	
			</div>
			<ul>
					<li onclick="locationFun(0)">강남본사<span>VIEW</span></li>
					<li onclick="locationFun(1)">부천지점<span>VIEW</span></li>
					<li onclick="locationFun(2)">용인지점<span>VIEW</span></li>
					<li onclick="locationFun(3)">광주지점<span>VIEW</span></li>
					<li onclick="locationFun(4)">안양지점<span>VIEW</span></li>
					<li onclick="locationFun(5)">분당지점<span>VIEW</span></li>
					<li onclick="locationFun(6)">수원지점<span>VIEW</span></li>
					<li onclick="locationFun(7)">기흥지점<span>VIEW</span></li>
					<li onclick="locationFun(8)">일산지점<span>VIEW</span></li>
					<li></li>
...
$("#main-content figure").attr("style","");
$("#main-content img").attr("style","margin:0 auto 20px;");
$("#main-content .left_content article").attr("style","width:100%;");
$("#main-content .left_content").attr("style","width:100%;");
$("#main-content h1").attr("style","");
$("#main-content img").addClass("img-responsive");
$("#main-content figure").addClass("img-responsive");
