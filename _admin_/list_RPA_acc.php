			...
			<div class="conwrap">
				...
				<div class="search">
					<div class="selectbox w100p" >
    					...
    					<DIV style="width: 400px;margin:-38px 0 10px 1631px;">
...
$QUERY_STR = "&e_option1=".$e_option1."&e_option2=".$e_option2."&e_option3=".$e_option3."&g_option=".$g_option."&b_option=".$_GET["b_option"]."&s_str=".$_GET["s_str"];
...
$(document).ready(function(){
	...
	$('#e_option1').on('change',function(){
		...
		var newURL = window.location.protocol + "//" + window.location.host + window.location.pathname;
		window.location.href=newURL  + "?e_option1="+e_option1+"&e_option2="+e_option2+"&e_option3="+e_option3+"&g_option="+g_option+"&b_option="+escape(b_option)+"&s_str="+escape(s_str);
	});
	...
	function fetchUser()
	{
		...
		$.ajax({
			url:"select.php",
			method:"POST",
			data:{action:action,s_str:s_str,b_option:b_option,g_option:g_option, page:page,cst_type:cst_type,e_option1:e_option1,e_option2:e_option2,e_option3:e_option3},
	...
	$('#excel').click(
		function() {
			...
			var userid="<?= $userid ?>";
			var depid="<?= $depid ?>";
			var go_url = "excel_down_acc.php?e_option1="+e_option1+"&e_option2="+e_option2+"&e_option3="+e_option3+"&s_option="+s_option+"&g_option="+g_option+"&s_str="+s_str+"&depth="+depth+"&userid="+userid+"&depid="+depid+"&s_date1="+s_date1+"&s_date2="+s_date2;
