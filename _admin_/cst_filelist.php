...
$id = $_GET["id"];
$path_info = "../tax_income/upload/2021/";
...
if(isset($id))
{
	$procedure = "
		...
		BEGIN
            ...
            ON A.CSTID = B.CSTID WHERE B.CST_TYPE_YEAR=DATE_FORMAT(now(), '%Y')-1 AND B.CST_TYPE='A1001' AND A.CSTID = '".$id."';
		END;
		";
...
function fetchUser()
{
	...
	$.ajax({
		...
		method:"POST",
		dataType:"json",
		data:{action:action,cstid:"<?php echo $_GET["id"]?>"},
