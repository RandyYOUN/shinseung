...
$selected = "";
	...
	for($i=0; $i <=12; $i++ ){
		...
		switch($i){
			...
			case 1 : $output.= '<option value="10" '.$selected.'>세무</option>';break;
			
			case 2 : $output.= '<option value="11" '.$selected.'>회계</option>';break;
				
			case 3 : $output.= '<option value="1" '.$selected.'>강남</option>'; break;

			case 4 : $output.= '<option value="2" '.$selected.'>용인</option>';break;
			
			case 5 : $output.= '<option value="3" '.$selected.'>안양</option>';break;
			
			case 6 : $output.= '<option value="4" '.$selected.'>수원</option>';break;
			
			case 7 : $output.= '<option value="5" '.$selected.'>일산</option>';break;
			
			case 8 : $output.= '<option value="6" '.$selected.'>부천</option>';break;
			
			case 9 : $output.= '<option value="7" '.$selected.'>광주</option>';break;
			
			case 10 : $output.= '<option value="8" '.$selected.'>분당</option>';break;
			
			case 11 : $output.= '<option value="9" '.$selected.'>기흥</option>';break;
