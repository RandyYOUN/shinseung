...
<head>
	<meta charset="utf-8">
	<title>세무톡 - 종합소득세 신고전문</title>
	<meta name="viewport"
		content="width=device-width, initial-scale=1.0, minimum-scale=1.0, maximum-scale=2.0, user-scalable=yes">
	<meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1" />
	<meta property="og:type" content="website">
	<meta property="og:title" content="세무톡 - 종합소득세 신고전문센터">
	<meta property="og:url" content="http://taxtok.kr/">
	<meta property="og:description" content="종합소득세 쉽고 편한 세무톡">
	<meta property="og:image" content="resources/images/sum_income.jpg">
...
<!-- 2019.04.23 yes@einvention -->
<!-- Google Tag Manager -->
<script>(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':
new Date().getTime(),event:'gtm.js'});var f=d.getElementsByTagName(s)[0],
j=d.createElement(s),dl=l!='dataLayer'?'&l='+l:'';j.async=true;j.src=
'https://www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);
})(window,document,'script','dataLayer','GTM-KRCSB26');</script>
...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-KRCSB26"
height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
<!-- End Google Tag Manager (noscript) -->

		<section class="mquick">
			<h1>무엇을 도와드릴까요?</h1>
			<h2 id="phone_hide2" name="phone_hide2">전화상담
				<a href="tel:1899-3582" class='IfdoVirtualPage' data-url='tel_request.html' data-title='전화상담 요청'></a>
			</h2>
			<div>
				<h3>채팅상담</h3>
		...
		<div class="wrap">		
			...
			<header>
				<a href="index.php"><img src="resources/images/logo.png"><span class="logotitle">종합소득세 신고전문</span></a>
