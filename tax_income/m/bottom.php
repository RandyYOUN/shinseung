...
?>	
	<div class="mgnb">
		<a href="index.php">
			<h1><img src="resources/images/logo.png"><span class="logotitle">종합소득세 신고전문</span>
<?php 
if ($username != ""){   
?>			
			<span class="login"><strong><?php echo $username;?></strong> 님</span>
<?php 
}
?>			
			</h1>
...
?>
			<li>
				<a href="<?php echo $KAKAO_OAUTH_URI?>">로그인</a>
			</li>
			<li>
				<a href="javascript:window.location.href='login_kakao.php'">회원가입</a>
			</li>
<?php 
}else{
?>
