			...
			<ul>
				<li>
					...
					<div>
						...
						<!--h1 style="font-size:22px;padding-top:20px;">종합소득세 간편안내서비스를 이용해주세요.</h1-->
...
function tag(e){
	...
	$(document).ready(function () {
		...
		$('#tab01').click(function () {
			$("#sp_income1").css("display","block");
			$("#sp_income2").css("display","block");
			$("#sp_income3").css("display","none");
		});

		$('#tab02').click(function () {
			$("#sp_income1").css("display","none");
			$("#sp_income2").css("display","none");
			$("#sp_income3").css("display","block");
		});
