		<section class="customer">
			<ul>
				<li class="tel">
					...
					<h3><strong>일산지점</strong>031-932-0863</h3>
				</li>
				<li>
					<h4>거래처 상담</h4>
					<h5>신규 계약 상담</h5>
				...
				<li>
					...
					<span>상담하기</span>
					<a href=" http://pf.kakao.com/_xmxjIHK/chat" target="_blank"> </a> </li> 
				<li>
					<h4>신규 상담</h4>
					<h5>신규 기장 및 신고 문의 </h5>
					<span>상담하기</span>
		...
		<footer>
			<ul>
				...
				<li>대표자 : 변기영</li>
				<li>개인정보보호책임자 : 정혜숙</li>
				<li>대표번호 : 031-932-0863</li>
				<li>사업자등록번호 : 128-85-42585</li>
				<li>경기도 고양시 일산동구 중앙로 1305-30 일산마이다스오피스텔 112호</li>
			</ul>
