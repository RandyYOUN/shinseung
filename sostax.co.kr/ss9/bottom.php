		<section class="customer">
			<ul>
				<li class="tel">
					...
					<h3><strong>기흥지점</strong>031-211-0608</h3>
				</li>
				<li>
					<h4>거래처 상담</h4>
					<h5>신규 계약 상담</h5>
				...
				<li>
					...
					<span>상담하기</span>
					<a href=http://pf.kakao.com/_xmxjIHK/chat target="_blank"> </a> </li> <li>
						<h4>신규 상담</h4>
						<h5>신규 기장 및 신고 문의 </h5>
						<span>상담하기</span>
						<a href="http://pf.kakao.com/_ZavYT/chat" target="_blank"></a>
		...
		<footer>
			<ul>
				...
				<li>개인정보보호책임자 : 정혜숙 </li>
				<li>대표자 : 변기영</li>
				<li>사업자등록번호 : 680-85-00797</li>
				<li>전화번호 : 031-211-0608</li>
				<li>경기도 용인시 기흥구 흥덕2로117번길 15</li>	
			</ul>
