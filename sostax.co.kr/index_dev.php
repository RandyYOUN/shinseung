		...
		<section id="promotionBanner" class="popup">
				<div class="popContents">
					<a href="javascript:window.open('http://pf.kakao.com/_vexexkC/chat');">
...
if( !getCookie("close20090524") ){ 
	window.open("popup.php","_blank","width=740, height=945,location=no,menubar=no,scrollbars=no,status=no,titlebar=no,toolbar=no");
} 
				...
				<div>
					...
					<ul>
						...
						<li>
							...
							<h2>양해운 대표세무사<br>실무 재산제세 세미나</h2>
						</li>
					</ul>
				</div>
...
$QUERY = "SELECT * FROM (
SELECT *,LEFT( fnStripTags(CONTENTS_),200) AS CONTENTS_1, date_format(NEWS_REGDATE, '%Y-%m-%d') AS REGDATE_, (CASE WHEN IFNULL(IMG_URL ,'') = '' THEN 'http://sostax.kr/news/images/default.jpg' ELSE IMG_URL END ) AS IMG_URL_    FROM dbsschina.SS_NEWS 
...
$result2 = @mysql_query($QUERY) or die("SQL error");
		...
		<section class="people">
			...
			<div class="tabBlock">
				<ul class="tabBlock-tabs">
					<li class="tabBlock-tab solo is-active ">
						<span><strong>대표세무사</strong>양해운</span>
					</li>
					...
					<li class="tabBlock-tab">
						<span><strong>주식평가전문</strong>송광호</span>
						<span><strong>중국세무전문</strong>정혜숙</span>
					</li>
					<li class="tabBlock-tab">
						<span><strong>양도세전문</strong>이인준</span>
						<span><strong>상속세전문</strong>유수현</span>
					</li>
				</ul>
				...
				<div class="tabBlock-content">
					<div class="tabBlock-pane">
						<div class="solo">
							<img src="resources/images/people0101.png">
							<h3>대표세무사</h3>
							<h4>양해운</h4>
							<h5>
							...
							<h6>
								<strong class="book">저서</strong>
								<li>양도세, 증여세, 상속세 세법집행기준 발간 (국세청)</li>
								<li>비사업용 토지에 대한 가이드북 발간 (국세청)</li>
								<li>비사업용 토지의 세무실무 발간 (2009년)</li>
								<li>양도소득세 법령 해석 발간 (2015년, 2016년 개정판)</li>
							</h6>

							<div class="label">
								<p>국세청경력</p>
								<span>41</span><span>년</span>
							</div>
						</div>
					</div>
					<!--tabBlock-pane-->
					...
					<div class="tabBlock-pane">
						<div>
							<img src="resources/images/people0106.png">
							<h3>세무사</h3>
							<h4>송광호</h4>
							<h5>
							...
							<div class="label">
								<p class="labelText">주식평가<br>전문</p>
							</div>
						</div>
						<div>
							<img src="resources/images/people0107.png">
							<h3>세무사</h3>
							<h4>심지현</h4>
							<h5>
							...
							<div class="label">
								<p class="labelText">중국세무<br>전문</p>
							</div>
						</div>
					</div>
					<!--tabBlock-pane-->
					...
					<div class="tabBlock-pane">
						<div>
							<img src="resources/images/people0108.png">
							<h3>세무사</h3>
							<h4>이인준</h4>
							<h5>
							...
							<div class="label">
								<p class="labelText">양도세<br>전문</p>
							</div>
						</div>
						<div>
							<img src="resources/images/people0109.png">
							<h3>세무사</h3>
							<h4>유수현</h4>
							<h5>
								<li><strong>재산제세 신고 및 컨설팅</strong></li>
