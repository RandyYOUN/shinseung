		<section class="customer">
			<ul>
				<li class="tel">
					...
					<h3><strong>안양지점</strong>031-387-0806</h3>
				</li>
				<li>
					<h4>거래처 상담</h4>
					<h5>신규 계약 상담</h5>
				...
				<li>
					...
					<span>상담하기</span>
					<a href="javascript:window.open('http://pf.kakao.com/_xmxjIHK/chat');"> </a> </li> <li>
					<h4>신규 상담</h4>
					<h5>신규 기장 및 신고 문의 </h5>
					<span>상담하기</span>
					<a href="http://pf.kakao.com/_eLLxkT/chat" target="_blank"></a>
		...
		<footer>
			<ul>
				...
				<li>대표자 : 변기영</li>
				<li>개인정보보호책임자 : 정혜숙</li>
				<li>대표번호 : 031-387-0806</li>
				<li>사업자등록번호 : 138-85-09278</li>
				<li>경기도 안양시 동안구 시민대로 277 108호 (관양동, 세방글로벌시티)</li>
			</ul>
