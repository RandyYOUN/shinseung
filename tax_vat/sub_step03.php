...
<div class="wrap">
    ...
    <section class="step03">
        ...
        <div class="fR">
            <h1>부가세 신고대행을 의뢰해주셔서 감사드리며, <br>
아래의 계좌로 수수료를 입금 부탁드립니다. <br><br>

입금 예정이시면 [입금 예정] 버튼을 클릭해주시고, <br>
입금을 하셨다면 [입금 완료] 버튼을 클릭해주십시오. <br><br>


수수료 입금 확인 후 고객님 정보로 현금영수증 또는 세금계산서 발행을 도와드립니다.
</h1> 
            <div class="total">
                <span>신고대행 수수료</span>
                <span><em id="est_fee" name="est_fee">110,000</em>원</span>
            </div>    
            <h3>입금시 신고대행 의뢰자명으로 입금 요청드립니다. <br>신고대행 수수료는 서류 검토 후 조정될 수 있습니다. 이점 양해부탁드립니다
</h3>   
            <div class="bank">               
                <div>
                    <h2>수수료 입금계좌</h2>
                    <span><em>은행명</em>국민은행</span>
                    <span><em>계좌주</em>세무법인신승</span>
                    <span><em>계좌번호</em><strong>532001-01-317506</strong></span>
                </div>                
            </div> 
            <div class="btn">
