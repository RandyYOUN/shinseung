...
//echo '$_GET["action"] = '.$_GET["action"].'<br>';

		if($_GET["action"] == '기장'){
			$_param['phone'] = '01055904957|01023526362|01025803733'; //한예주		
		}else if($_GET["action"] == '양도'){
			$_param['phone'] = '01055904957|01023526362|01022997901'; // 이인준
		}
/*
		switch($_GET["action"]){
			case "기장" : $_param['phone'] = '01023526362';//'01055904957|01025803733'; //한예주
			case "양도" : $_param['phone'] = '01055904957';//'01055904957|01022997901'; // 이인준
		}
*/

//echo '$_param[phone] = '.$_param['phone'].'<br>';
		//$_param['phone'] = '01055904957';       // [필수] 수신번호 - 여러명일 경우 |로 구분 '010********|010********|010********'
