<?php include("top.php");?>
		...
		<!--section class="link2" name="link2" id="link2">
			<h1>부가세 간편 안내서비스</h1>
			<h2>부가세 <B>안내문</B>을 올려 주시면 검토하여 <br><B>세액, 환급금, 수수료를 안내해드립니다.</B></h2>
			<div class="wrapDiv">
				...
				<div class="filebox"> 
				  <label for="upfile"  style="width:100%;">부가세 안내문 업로드</label> 
		...
		<!--  >section class="addtax">
			<h1><span>쉽고, 싸고, 편한 부가세 신고</span></h1>
			<h2> <br>

부가가치세 신고대행 수수료 안내 및  <br>
부가가치세 신고시 감면 가능 여부도 함께 검토해 드립니다. 
<br></h2>
			<h3>부가세 간편 서비스</h3>
			<a href="sub_step01.php"></a>
		</section-->
