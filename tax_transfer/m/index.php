<?php include("top.php");?>
		...
		<section class="mainvisual">
			<h1>국세청 33년 경력</h1>
			<h2>양도소득세 <br>국내 최다 상담 및 신고처리</h2>
		</section>
		...
		<section class="link">
			...
			<div>
				...
				<a href="javascript:go_kakao();" class="chatting IfdoVirtualPage" data-url='chat_request.html' data-title='채팅상담 요청'>채팅상담</a>
			</div>
		</section>
		...
		<section class="price">
			...
			<ul>
				...
				<li>
					<h2>양도소득세</h2>
					<h3>고액 절세액 발생시 <br>추가 수수료 별도 협의 </h3>
					<div>
		...
		<section class="heavytax">
			...
			<h2><span>다주택자 이번 기회에 집 안팔면<br>더 센 <b>'세금폭탄'</b>이 기다립니다</span></h2>
			<div>
				<h3>2020년 6월 말까지 10년이상 보유 다주택자</h3>
				<h4>양도세 중과 한시 면제</h4>
				<h5>
		...
		<section class="benefit">
			...
			<ul>
				...
				<li>
					<h2>맞춤정보 제공</h2>
					<h3>카톡, 양도세, 문자로 증여세, 상속세 등 유용한 정보를 무료로 제공해드립니다.</h3>
					<div>
		...
		<section class="people">
			...
			<h2>세무톡은 국세청 33년 경력 신승세무법인의 <br>스마트 세무회계 서비스 브랜드입니다</h2>
			<h3>세무사 이력 전체보기</h3>
		...
		<section class="process">
			...
			<div class="swiper-container">
				<div class="swiper-wrapper">
					<div class="swiper-slide processDiv">
						<h2>STEP 1</h2>
						<li>온라인 / 전화 접수 계약금 입금요청</li>
						<li>1 : 1 전담 전문 세무사 배정</li>
						<li><span>알림안내</span>기초 세무 상담 준비 자료 접수</li>
						<li>대상 자산 및 기초 현황분석</li>
					</div>
					<div class="swiper-slide processDiv">
						<h2>STEP 2</h2>
						<li><span>알림안내</span>절세방안 / 대안 검토</li>
						<li>세액 1차 산출</li>
						<li><span>알림안내</span>예상 세액 안내 추가 자료 요청</li>
						<li>세액 1차 조정</li>
					</div>
					<div class="swiper-slide processDiv">
						<h2>STEP 3</h2>
						<li>사례별 시뮬레이션 추가 절세방안 모색</li>
						<li>전담팀 2차 세액 산출</li>
						<li><span>알림안내</span>예상 세액 안내 추가 자료 요청</li>
						<li><span>알림안내</span>세액 산정완료 잔금 입금요청</li>
					</div>
					<div class="swiper-slide processDiv">
						<h2>STEP 4</h2>
						<li>잔금 입금확인</li>
						<li>세무서 신고</li>
						<li><span>알림안내</span>신고서 / 납부서 전송 산출세액 전달</li>
						<li>사후 관리 지원</li>
					</div>
				</div>
			</div>
		...
		<section class="difference">
			<h1>전문가는 확실히 다릅니다</h1>
			<h2>복잡한 양도소득세 세무톡이 알아서 다 해드릴께요</h2>
			<ul>
				<li>
					<h3>압도적인 수임 사례</h3>
					<h4>양도소득세관련 수많은 상담 및 다양한 사례 수임으로 전문성을 갖추고 있어 믿을 수 있습니다</h4>
				</li>
				<li>
					<h3>사전 절세컨설팅 지원</h3>
