...
{ 
	...
	{ 
		...
		BEGIN
		INSERT INTO NEW_HP(NEW_HP,Q_TYPE,REGDATE,GUBUN) VALUES(NEW_HP,Q_TYPE,NOW(),'양도소득세');
		END
		";
		...
		{ //위에서 만든 프로시저 실행
			if(mysqli_query($connect,$procedure))
			{
				...
				switch($Q_TYPE){
					case "기장" : $_param['phone'] = '01038484309'; //정혜숙
					case "양도" : $_param['phone'] = '01092587740'; // 김세현
				}
				//$_param['phone'] = $NEW_HP;       // [필수] 수신번호 - 여러명일 경우 |로 구분 '010********|010********|010********'

				$_param['msg'] = '양도소득세 사이트에서 '.$NEW_HP.' 번호로 '.$Q_TYPE. '전화상담 문의가 왔습니다. 응대부탁드립니다.';
				$_param['subject'] = '응대요청';
...
전화상담 가능시간 : 평일 오전 10시 ~ 오후 6시';
					...
					case "양도" : echo '성공적으로 전화상담 요청이 신청되었습니다. 
조금만 기다려주시면 빠르고 전문적인 전화상담이 가능합니다. 
전화상담 가능시간 : 평일 오전 10시 ~ 오후 6시';
					break;
