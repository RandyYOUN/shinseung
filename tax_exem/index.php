	...
	<div class="wrap">
		...
		<header>
			...
			<video muted loop id="myVideo">
				<source src="https://taxtok.kr/tax_vat/resources/images/video.mp4" type="video/mp4">
				</source>
			</video>
...
<section class="vat">
			<div>
				<div>
					<h1>쉽고, 싸고, 편한 사업장 현황신고 </h1>
					<h2>면세사업장현황 신고대행 수수료 안내 및<BR>신고시 감면 가능 여부도 함께 검토해 드립니다.</h2>
					<a href="sub_step01.php" style="width:545px;">면세사업장현황 간편 서비스</a>
				</div>
			</div>
		</section>
		<section class="link">
			...
			<div>
				<h1>면세사업장현황신고 전문 세무톡 </h1>
				<h2>번거로운 면세사업장현황신고 세무톡에 맡기고 일에만 전념하세요!</h2>
		...
		<section class="compare">
			<h1>더 이상 고민말고</h1>
			<h2>똑똑한 면세사업장현황 신고로 절세혜택을 받아보세요</h2>
			<ul>
				<li>
					<h3>세무톡을 모르면</h3>
					<h4>
...
$QUERY = "SELECT ID,SUBJECT,LEFT(REGEXP_REPLACE(CONTENTS_, '<[^>]+>',''),100) AS CONTENTS_   
FROM dbsschina.SS_NEWS WHERE VISIBLE='Y' and cate='HOM' ORDER BY REGDATE DESC  LIMIT 0, 3 ;";
