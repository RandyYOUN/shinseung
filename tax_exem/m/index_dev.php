<?php include("top.php");?>
		...
		<section class="link">
			...
			<div>
				...
				<a href="javascript:ChannelIO('show');" class="chatting">채팅 상담</a>
			</div>
		</section>
		...
		<section class="link2" name="link2" id="link2">
			...
			<div class="wrapDiv">
				...
				<input type="text" name="HOME_Q1" id="HOME_Q1" placeholder="[답변 예시 : 2주택]" style="width:100%"><BR><BR>
				<h3><b>연간 주택임대소득 </b></h3> <BR>
				<input type="text" name="HOME_Q2" id="HOME_Q2" placeholder="[답변 예시 : 1번주택 월세 30만원 보증금 1억]" style="width:100%;"><BR><BR>
				<h3><b>공동명의 여부</b></h3> <BR>
				<input type="text" name="HOME_Q3" id="HOME_Q3" placeholder="[답변 예시: 1번 주택 단독명의]" style="width:100%;"><BR><BR>
