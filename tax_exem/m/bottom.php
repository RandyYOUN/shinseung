	...
	<div class="mgnb">
		<a href="index.php">
			<h1><img src="resources/images/logo.png"><span class="logotitle">면세사업장현황 신고전문</span></h1>
		</a>
		<ul>
			<li>
...
function hide_time(){
	...
	if(day == 1){
		if(hour > 0){
			$('#s_price1').attr('style', "display:none;");
			$('#s_price2').attr('style', "display:block;");
