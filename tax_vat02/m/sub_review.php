...
$query = "SELECT count(ID) as total, round( avg(REV_SCORE),1) AS t_score,TRUNCATE( avg(REV_SCORE),0) AS t_score_star  FROM SS_REVIEW WHERE REV_CATE = '종합소득세' ".$STR.$STR2;
...
$QUERY = "SELECT *, phone_fn(REV_HP) AS REV_HP_ FROM SS_REVIEW WHERE REV_CATE = '종합소득세' ORDER BY REV_REGDATE DESC LIMIT $limit_idx, $page_set ;";
