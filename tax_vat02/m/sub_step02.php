				...
				<section class="step02T">
				  ...
				  <section class="step02">
						...
						<div class="fR">
							...
							<input type="button" value="다  음" id="action_step02" name="action_step02" >
						</div>
					</section> 
		</section>
...
$(document).ready(function(){
	...
	function fetchUser()
	{
		...
		$.ajax({
			...
			if(data.OPTION1 == 'Y'){
				...
				$('[name=check01]').prop('checked', false);
			}
			...
			if(data.OPTION5 == 'Y'){
				$('[name=check05]').prop('checked', true);
				} else{
					$('[name=check05]').prop('checked', false);
					}
	...
	$('#action_step02').click(function(){
		...
		var option7 = $('#check07').val().replace("on","");
		var option8 = $('#check08').val().replace("on","");
		var option9 = $('#check09').val().replace("on","");
		var option10 = $('#check10').val().replace("on","");
		var option11 = $('#check11').val().replace("on","");
