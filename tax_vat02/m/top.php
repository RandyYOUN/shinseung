...
<!-- End Google Tag Manager -->
	...
	<meta property="og:description" content="부가세 쉽고 편한 세무톡">
...
<script type="text/javascript">
      //kakaoPixel('3306585963752997547').pageView();
</script>
...
<body>
		...
		<section class="mquick">
			...
			<h2 id="phone_hide2" name="phone_hide2">전화상담
				<a href="tel:1899-3582" onclick="gtag('event', '부가세_전화연결', { 'event_category' : '버튼클릭','event_label' : '모바일_하단_전화연결'});" class='IfdoVirtualPage' data-url='tel_request.html' data-title='전화상담 요청'></a>
			</h2>
			<div>
				<h3>채팅상담</h3>
		...
		<div class="wrap">		
			...
			<header>
				<a href="index.php"><img src="resources/images/logo.png"><span class="logotitle">부가세 신고전문</span></a>
