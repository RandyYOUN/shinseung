	...
	<div class="wrap">
		...
		<section class="link2">
			...
			<div class="wrapDiv">
				...
				<input type="text" name="QUEST" id="QUEST" placeholder="문의사항을 입력해주세요" style="width:472px;"><BR><BR>
			...
			<h4>불편한 종합소득세 <strong>이젠 안녕!</strong></h4>
		</section>
...
$QUERY = "SELECT *,LEFT( fnStripTags(CONTENTS_),100) AS CONTENTS_, date_format(NEWS_REGDATE, '%Y-%m-%d') AS REGDATE_, (CASE WHEN IFNULL(IMG_URL ,'') = '' THEN 'http://sostax.kr/news/images/default.jpg' ELSE IMG_URL END ) AS IMG_URL_    FROM dbsschina.SS_NEWS WHERE VISIBLE='Y' and cate='CIT' ORDER BY REGDATE DESC  LIMIT 0, 3 ;";
