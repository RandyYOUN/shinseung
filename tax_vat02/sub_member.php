<?php include("top.php");?>
	<div class="wrap">
		...
		<div class="s_member">
			<section class="threenumber">
				<ul>
					<li>
						<span><img src="resources/images/s_membernum01.png"></span>
						<span>세무 전문가 그룹 국세청 경력 </span>
						<span><strong class="counter">33</strong><strong>년</strong></span>
					</li>
					<li>
						<span><img src="resources/images/s_membernum02.png"></span>
						<span>세무회계 경영컨설팅 전문가 </span>
						<span><strong class="counter">70</strong><strong>명</strong></span>
					</li>
					<li>
						<span><img src="resources/images/s_membernum03.png"></span>
						<span>수도권 직영 지점 운영 </span>
						<span><strong class="counter">15</strong><strong>개</strong></span>
					</li>
				</ul>
			</section>
			...
			<section class="member">
				<h1>검증된 세무회계 노하우 </h1>
				<h2>믿고 맡길 수 있는 70여명의 세무회계 및 경영컨설팅 전문가가 번거롭고 복잡한 세무업무를 책임져드립니다</h2>
				<ul>
					<li class="long">
						<img src="resources/images/member01.png">
						<h4><span>국세청경력<strong>41년</strong></span></h4>
						<div>
							<h3><span>대표세무사</span><span>양해운</span></h3>
							<ol>
								<li><strong>국세공무원 교육원 상속세, 증여세법 교수 역임</strong></li>
								<li><strong>국세청 재산제세 분야 26년 근무</strong></li>
								<li><strong>국세청 법규과 법령 해석 담당</strong></li>
								<li>국세청 재산세과 기획 담당</li>
							</ol>
							<ol>
								<li>국세청 심사1과 불복심리 담당</li>
								<li>양도소득세, 증여세, 상속세 법령해석</li>
								<li>1세대 1주택 비과세 검증프로그램 개발 (국세청)</li>
								<li>일선 세무서 재산세과 실무 담당</li>
							</ol>
							<dl>
								<dd>[저서] 양도세, 증여세, 상속세 세법집행기준 발간 (국세청)</dd>
								<dd>[저서] 비사업용 토지의 세무실무 발간 (2009년)</dd>
							</dl>
							<dl>
								<dd>[저서] 양도세, 증여세, 상속세 세법집행기준 발간 (국세청)</dd>
								<dd>[저서] 비사업용 토지의 세무실무 발간 (2009년)</dd>
					...
					<li>
						<img src="resources/images/member02.png">
						<h4><span>국세청경력<strong>27년</strong></span></h4>
						<div>
							<h3><span>대표세무사</span><span>황재윤</span></h3>
							<ol>
					...
					<li>
						<img src="resources/images/member03.png">
						<h4><span>세무컨설팅<strong>20년</strong></span></h4>
						<div>
							<h3><span>대표세무사</span><span>변기영</span></h3>
							<ol>
					...
					<li>
						<img src="resources/images/member04.png">
						<h4><span>국세청경력<strong>38년</strong></span></h4>
						<div>
							<h3><span>대표세무사</span><span>전명호</span></h3>
							<ol>
					...
					<li>
						<img src="resources/images/member05.png">
						<h4><span>국세청경력<strong>33년</strong></span></h4>
						<div>
							<h3><span>대표세무사</span><span>박호열</span></h3>
							<ol>
					...
					<li>
						<img src="resources/images/member06.png">
						<h4><span>회계컨설팅<strong>22년</strong></span></h4>
						<div>
							<h3><span>회계사</span><span>오종석</span></h3>
							<ol>
					...
					<li>
						<img src="resources/images/member07.png">
						<h4><span>회계컨설팅<strong>20년</strong></span></h4>
						<div>
							<h3><span>회계사</span><span>안장순</span></h3>
							<ol>
								<li><strong>공인회계사</strong></li>
					...
					<li>
						<img src="resources/images/member08.png">
						<h4 class="labelshort"><strong>주식평가</strong>전문</h4>
						<div>
							<h3><span>세무사</span><span>송광호</span></h3>
							<ol>
								<li><strong>재신제세 컨설팅 총괄</strong></li>
								<li><strong>국세청 근무 10년</strong></li>
								<li><strong>기업 주식평가 자문</strong></li>
								<li>기업 비상장주식평가 자문</li>
							</ol>
							<ol>
								<li>기업 자산관리 세무플레닝</li>
								<li>양도세, 증여세, 상속세 절세 컨설팅</li>
								<li>과세자료 소명 & 과세전 적부심 청구 자문</li>
							</ol>
						</div>
					</li>
					<!--li>
						<img src="resources/images/member09.png">
						<h4 class="labelshort"><strong>중국세무</strong>전문</h4>
						<div>
							<h3><span>세무사</span><span>심지현</span></h3>
							<ol>
								<li><strong>한중 세무회계 컨설팅</strong></li>
								<li><strong>중국법령정보센터 세무상담</strong></li>
								<li><strong>한국지사 세무회계 검토 자문</strong></li>
								<li>중문 재무보고서 검토 자문</li>
							</ol>
							<ol>
								<li>세무신고 및 연말정산 자문</li>
							</ol>
						</div>
					</li-->
					<li>
						<img src="resources/images/member010.png">
						<h4 class="labelshort"><strong>양도세</strong>전문</h4>
						<div>
							<h3><span>세무사</span><span>이인준</span></h3>
							<ol>
								<li><strong>재산제세 신고 및 컨설팅</strong></li>
								<li><strong>양도소득세 절세방안 컨설팅</strong></li>
								<li>1가구 1주택 비과세 절세 컨설팅</li>
								<li>1가구 2주택 양도소득세 절세방안 자문</li>
							</ol>
							<ol>
								<li>다주택자 양도세 절세방안 자문</li>
								<li>재개발 재건축 조합 절세 컨설팅</li>
							</ol>
						</div>
					</li>
					<li>
						<img src="resources/images/member011.png">
						<h4 class="labelshort"><strong>상속세</strong>전문</h4>
						<div>
							<h3><span>세무사</span><span>유수현</span></h3>
							<ol>
								<li><strong>재산제세 신고 및 컨설팅</strong></li>
								<li><strong>상속세, 증여세 절세방안 컨설팅</strong></li>
								<li>가업승계 상속 절세방안 컨설팅</li>
								<li>비사업토지 절세방안 컨설팅</li>
							</ol>
							<ol>
								<li>사전증여 절세방안 컨설팅</li>
								<li>상속세 신고 및 납부 자문</li>
							</ol>
						</div>
					</li>
				</ul>
