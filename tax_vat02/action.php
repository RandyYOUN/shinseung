...
{ 
	...
	{ 
		...
		BEGIN
			...
			IF CNT_CSTID = 0 THEN
				...
				CALL INSERT_TB100022(TMP_CSTID,'부가세','2021','1',NULL, NULL, '9',NULL,NULL);
	...
	{ 
		...
		$procedure = "CREATE DEFINER=`sschina`@`%` PROCEDURE `INSERT_TB100024`(
		IN P_BIZID INT(11), 
		P_OPT1 varchar(1), 
		P_OPT2 varchar(1), 
		P_OPT3 varchar(1), 
		...
		BEGIN
			...
			IF CNT = 0 THEN
				INSERT INTO TB100024(BIZ_ID, OPTION1,OPTION2,OPTION3,OPTION4,OPTION5,OPTION6,OPTION7,OPTION8,OPTION9,OPTION10, OPTION11,REGDATE ) 
				VALUES(P_BIZID,P_OPT1,P_OPT2,P_OPT3,P_OPT4,P_OPT5,P_OPT6,P_OPT7,P_OPT8,P_OPT9,P_OPT10,P_OPT11,NOW());
			ELSE
		...
		{ //위에서 만든 프로시저 실행
			if(mysqli_query($connect,$procedure))
			{
				$query = "CALL INSERT_TB100024('".$bizid."','".$option1."','".$option2."','".$option3."','".$option4."','".$option5."','".$option6."','".$option7."','".$option8."','".$option9."','".$option10."','".$option11."' , '".$est_fee."')";
				//프로시저 호출
				mysqli_query($connect,$query);
			}
		}
