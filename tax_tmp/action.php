...
{ 
	...
	{ 
		...
		BEGIN
		INSERT INTO NEW_HP(NEW_HP,Q_TYPE,REGDATE,GUBUN) VALUES(NEW_HP,Q_TYPE,NOW(),'소상공인연합회');
		END
		";
		...
		{ //위에서 만든 프로시저 실행
			if(mysqli_query($connect,$procedure))
			{
				...
				$_param['msg'] = '소상공인연합회 제휴에서 '. $NEW_HP.' 번호로 ['.$Q_TYPE. '] 전화상담 문의가 왔습니다. 응대부탁드립니다.';
				$_param['subject'] = '응대요청';
...
전화상담 가능시간 : 평일 오전 10시 ~ 오후 6시';
					...
					case "등록대행법인설립" : echo '성공적으로 전화상담 요청이 신청되었습니다. 
조금만 기다려주시면 빠르고 전문적인 전화상담이 가능합니다. 
전화상담 가능시간 : 평일 오전 10시 ~ 오후 6시';
					break;

					case "정책자금" : echo '성공적으로 전화상담 요청이 신청되었습니다. 
조금만 기다려주시면 빠르고 전문적인 전화상담이 가능합니다. 
전화상담 가능시간 : 평일 오전 10시 ~ 오후 6시';
					break;
...
정기적으로 카톡 또는 문자로 세무, 정책자금, 사업관련 필요정보를 맞춤제공해드립니다.';
					...
					case "제휴문의" : echo '성공적으로 제휴문의가 접수되었습니다. 
조금만 기다려주시면 빠르고 전문적인 전화상담이 가능합니다. 
전화상담 가능시간 : 평일 오전 10시 ~ 오후 6시';
					break;
					default:"default";
