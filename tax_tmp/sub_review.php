...
$QUERY = "SELECT *, phone_fn(REV_HP) AS REV_HP_,date_format(REV_REGDATE,'%Y-%m-%d') as REV_REGDATE_ FROM SS_REVIEW WHERE VISIBLE = 'Y' ORDER BY REV_REGDATE DESC LIMIT $limit_idx, $page_set ;";
