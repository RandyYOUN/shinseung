...
<select name="c_cate" id ="c_cate" class="form-control">
	<option value="">선택</option>
	<option value="c_tra">양도세</option>
	<option value="c_inh">상속세</option>
	<option value="c_gtx">증여세</option>
	<option value="c_btx">종합부동산세</option>
</select>
</DIV>
