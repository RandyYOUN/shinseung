	...
	{ 
		...
		{ //위에서 만든 프로시저 실행
			if(mysqli_query($connect,$procedure))
			{
				...
				if($Q_TYPE == '창업'){
					$_param['phone'] = '01055904957|01030925352'; //	노준석	
				}else if($Q_TYPE == '병원_등록대행법인설립'){
					$_param['phone'] = '01055904957|01030925352'; // 
				}else if($Q_TYPE == '병원_정책자금'){
					$_param['phone'] = '01055904957|01030925352'; // 
				}else if($Q_TYPE == '병원_제휴문의'){
					$_param['phone'] = '01055904957|01030925352'; // 
				}
...
☎ 1899-3582';   
				...
				switch($Q_TYPE){
					case "창업" : echo '성공적으로 전화상담 요청이 신청되었습니다. 
조금만 기다려주시면 빠르고 전문적인 전화상담이 가능합니다. 
전화상담 가능시간 : 평일 오전 10시 ~ 오후 6시';
					break;

					case "창업_등록대행법인설립" : echo '성공적으로 전화상담 요청이 신청되었습니다. 
조금만 기다려주시면 빠르고 전문적인 전화상담이 가능합니다. 
전화상담 가능시간 : 평일 오전 10시 ~ 오후 6시';
					break;

					case "창업_정책자금" : echo '성공적으로 전화상담 요청이 신청되었습니다. 
조금만 기다려주시면 빠르고 전문적인 전화상담이 가능합니다. 
전화상담 가능시간 : 평일 오전 10시 ~ 오후 6시';
					break;

					case "구독_창업" : echo '성공적으로 세무소식 무료구독이 등록되었습니다. 
정기적으로 카톡 또는 문자로 세무, 정책자금, 사업관련 필요정보를 맞춤제공해드립니다.';
					break;

					case "창업_제휴문의" : echo '성공적으로 제휴문의가 접수되었습니다. 
조금만 기다려주시면 빠르고 전문적인 전화상담이 가능합니다. 
전화상담 가능시간 : 평일 오전 10시 ~ 오후 6시';
					break;
					default:"default";
