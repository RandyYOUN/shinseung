...
$QUERY = "SELECT *,phone_fn( REPLACE( PHONE ,'-','') ) AS PHONE_ FROM SS_QNAS where ID_ = $id;";
		...
		<div class="s_news">
			...
			<section class="newsview">
				<div class="contents">
					...
					<h2><B>Q. 문의 내용</B></h2>
					<h4>
						<DIV style="white-space:pre-wrap ;"><?php echo $row["CONTENTS"] ?></DIV>
