...
<html>
	<head>
		...
		<script type="text/javascript" src="resources_/js/aa.js"></script>
			...
			<div class="tabsWrap">
				...
				<section class="tabarea">
					<div>
						...
						<h2><span>급여대장 및 급여세액 간편 요청 속 썩이던 직원 & 급여관리
								이젠 훨씬 편해집니다</span></h2>
						<img src="resources_/images/s_smartcon0101.png" style="right:-50px; bottom:150px; width: 370px;">
						<ul>
					...
					<div>
						...
						<img src="resources_/images/s_smartcon0102.png" style="right:-50px; bottom:170px; width: 400px;">
						<ul>
					...
					<div>
						...
						<img src="resources_/images/s_smartcon0103.png" style="right:-30px; bottom:140px; width: 370px;">
						<ul>
					...
					<div>
						...
						<img src="resources_/images/s_smartcon0104.png" style="right:-50px; bottom:150px; width: 370px;">
						<ul>
					...
					<div>
						...
						<img src="resources_/images/s_smartcon0105.png" style="right:-50px; bottom:150px; width: 420px;">
						<ul>
					...
					<div>
						...
						<img src="resources_/images/s_smartcon0106.png" style="right:-50px; bottom:155px; width: 390px;">
						<ul>
				...
				<section class="tabarea">
					<div>
						...
						<img src="resources_/images/s_smartcon0201.png" style="right:-50px; bottom:170px; width: 390px;">
						<ul>
					...
					<div>
						...
						<img src="resources_/images/s_smartcon0202.png" style="right:-50px; bottom:130px; width: 400px;">
						<ul>
					...
					<div>
						...
						<img src="resources_/images/s_smartcon0203.png" style="right:-50px; bottom:155px; width: 370px;">
						<ul>
					...
					<div>
						...
						<img src="resources_/images/s_smartcon0204.png" style="right:-50px; bottom:180px; width: 390px;">
						<ul>
							<li class="highlight">경영관리 데이터 기반 미수금 내역 보고 및 관리 </li>
							<li>미수금 회수 가능여부 사전체크 지원 </li>
							<li>은행과 연계한 채권 선불지급 서비스 지원 </li>
					...
					<div>
						...
						<img src="resources_/images/s_smartcon0205.png" style="right:-50px; bottom:155px; width: 400px;">
						<ul>
				...
				<section class="tabarea">
					<div>
						...
						<img src="resources_/images/s_smartcon0301.png" style="right:-50px; bottom:160px; width: 380px;">
						<ul>
					...
					<div>
						...
						<img src="resources_/images/s_smartcon0302.png" style="right:-50px; bottom:160px; width: 380px;">
						<ul>
					...
					<div>
						...
						<img src="resources_/images/s_smartcon0303.png" style="right:-50px; bottom:120px; width: 400px;">
						<ul>
				...
				<section class=" tabarea">
					<div>
						...
						<img src="resources_/images/s_smartcon0401.png" style="right:-50px; bottom:155px; width: 400px;">
						<ul>
					...
					<div>
						...
						<img src="resources_/images/s_smartcon0402.png" style="right:-50px; bottom:150px; width: 390px;">
						<ul>
