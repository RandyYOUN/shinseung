	...
	<div class="wrap">
		...
		<header>
			...
			<section class="mainVisual">
				<div>
					<!--h1><img src="resources/images/main_img_new_20200420.jpg"></h1-->
...
$QUERY2 = "SELECT *,LEFT( fnStripTags(CONTENTS_),100) AS CONTENTS_, date_format(NEWS_REGDATE, '%Y-%m-%d') AS REGDATE_, (CASE WHEN IFNULL(IMG_URL ,'') = '' THEN 'http://sostax.kr/news/images/default.jpg' ELSE IMG_URL END ) AS IMG_URL_    FROM dbsschina.SS_NEWS WHERE VISIBLE='Y' ORDER BY rand() DESC  LIMIT 0, 3 ;";
...
?>
				<li>
					...
					<h2><?PHP echo mb_strimwidth($row["SUBJECTㄴ"],'0','35','...','utf-8')?></h2>
