<?php include("top.php");?>
	<div class="wrap">
		...
		<header class="subhead">
			...
			<section class="subvisual s_taxbg">
			</section>
		...
		<div class="s_tax">
			...
			<section class="s_form">
				<h1>스마트 세무회계 비서 <span>세무톡</span> </h1>
				<h2>번거로운 세무업무 세무톡에 맡기고 사업에만 전념하세요</h2>
				<img src="resources/images/linkpeople.png">
				<div>
					<label>세무기장 / 부가세신고 / 종합소득세 신고</label>
					<input type="text" name="NEW_HP1" id="NEW_HP1" placeholder="핸드폰번호를 입력해주세요"
						onKeyup="this.value=this.value.replace(/[^0-9]/g,'');"><button type="button" name="action1"
						id="action1" onclick="javscript:if(typeof _NB_PAGE=='function'){_NB_PAGE('transfer_action.html','전화상담 요청');};">전화상담 요청</button>
					<a href="javascript:ChannelIO('show');">채팅상담</a>
				</div>
			</section>

			<section class="subtitle mautoTop0">
				<h1>세무기장 장부작성</h1>
