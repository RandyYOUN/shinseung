...
$QUERY_STR = "&g_option=".$g_option."&s_str=".$_GET["s_str"];
...
?>
	...
	<input type=hidden id="page_flag" value="고객리뷰">
</body>
...
$(document).ready(function(){
	...
	function fetchUser()
	{
		...
		var action = "select_list_cst_review";
		...
		$.ajax({
			url:"select.php",
			method:"POST",
			data:{action:action,s_str:s_str,g_option:g_option, page:page},
	...
	$('#btn_cancel').click(
		function() {
			...
			window.location.href="?g_option="+g_option+"&s_str="+s_str+"&page="+page;
		}	
	);
