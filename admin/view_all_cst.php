		...
		<div class="mainbg">
			<div class="content">
				...
				<div class="btn w100" style="margin:5px 0 15px;">
					...
					<div class="dashwrap" style="width:1330px;">
...
DATE_FORMAT(DEADLINE_DATE, '%Y-%m-%d') 'DEADLINE_DATE_', SELECT_CODE_VALUE(ACC_FLAG) AS ACC_FLAG 
FROM dbsschina.TB100022 WHERE CSTID = P_CSTID ORDER BY REGDATE DESC;
	END;
	";
            ...
            while($row = mysqli_fetch_array($result)){
                ...
                $output .= '
					<tr>
                        ...
                        <td style="text-align:center;">'.$row["ACC_FLAG"].'</td>
