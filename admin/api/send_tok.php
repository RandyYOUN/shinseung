...
신고기한 : $DEADLINE_";
	                    ...
	                    if($ck_cnt == 0){
	                        ...
	                        // 알림톡 발송
	                        /*DB로그 남기기*/
	                        send_kakao_log($cstid, $SEND_PHONE, "bizp_2021080916341105928894221", "bcdc7fbde9bec506790e366bcc2b99d947868f10","STEP_1_CEO","A1003","",$cstid);
	                    }else{
	                        echo 'error:abuse';
	                    }
	                    /*회장님 : 끝*/
