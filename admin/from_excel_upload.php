...
<tbody>
	...
	<tr style="text-align:center;height:50px;">
		<td><input type="radio" name="rd_flag" id="rd_flag" value="hometax_agreement"></td>
		<td>수임동의</td>
		<td><a href="upload_income/template_upload_hometax_agreement.xlsx">down</a></td>
	</tr>
	<tr style="text-align:center;height:50px;">
	...
	<tr style="text-align:center;height:50px;">
		<td><input type="radio" name="rd_flag" id="rd_flag" value="smartaBookMake"></td>
		<td>SMARTA_자동 간편장부</td>
		<td><a href="upload_income/template_upload_smartaBookMake.xlsx">down</a></td>
	</tr>
	<tr style="text-align:center;height:50px;">
		<td><input type="radio" name="rd_flag" id="rd_flag" value="smarta"></td>
		<td>SMARTA_파일변환</td>
		<td><a href="upload_income/template_upload_smarta_new.xlsx">down</a></td>
	</tr>
	<tr style="text-align:center;height:50px;">
