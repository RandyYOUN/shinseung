						...
						<table>
							...
							<tbody class="pricecolor02">
								...
								<tr>
									<td>양도/증여</td>
									<td>5억원 ~ 10억원 미만</td>
									<td>400,000 + 5억초과액 x 0.14%</td>
								</tr>
								<tr>
									<td>양도/증여</td>
									<td>10억원 ~ 30억원 미만</td>
									<td>1,100,000 + 10억초과액 x 0.13%</td>
								</tr>
								<tr>
									<td>양도/증여</td>
									<td>30억원 ~ 50억원 미만</td>
									<td>3,700,000 + 30억초과액 x 0.12%</td>
								</tr>
								<tr>
									<td>양도/증여</td>
									<td>50억원 ~ 100억원 미만</td>
									<td>6,100,000 + 50억초과액 x 0.1%</td>
								</tr>
								<tr>
									<td>양도/증여</td>
									<td>100억원 초과</td>
...
*/
			...
			if(pay < 100000000){ //1억미만
			...
			}else if(pay >= 100000000 && pay < 300000000){ //1억이상 5억미만
				...
				switch(gubun){
					case "IND" : st1 = 400000;
								query1 = "계산식 => 양도/증여 : 3억이상 5억미만 = 400,000원";
								gubun_money = 400000;
								break;
				...
				switch(gubun){
					case "IND" : st1 = Math.ceil(400000 + (tmp1 * 0.0014));

								query1 = "계산식 => 400,000 + ( " + inputNumberWithComma(String(tmp1))+" x 0.14%)" ;
								gubun_money = 400000;
								break;
				...
				switch(gubun){
					case "IND" : st1 = Math.ceil(1100000 + (tmp1 * 0.0013));

								query1 = "계산식 => 1,100,000 + ( " + inputNumberWithComma(String(tmp1))+" x 0.13%)" ;
								gubun_money = 1100000;
								break;
				...
				switch(gubun){
					case "IND" : st1 = Math.ceil(3700000 + (tmp1 * 0.0012));

								query1 = "계산식 => 3,700,000 + ( " + inputNumberWithComma(String(tmp1))+" x 0.12%)" ;
								gubun_money = 3700000;
								break;
				...
				switch(gubun){
					case "IND" : st1 = Math.ceil(6100000 + (tmp1 * 0.001));

								query1 = "계산식 => 6,100,000 + ( " + inputNumberWithComma(String(tmp1))+" x 0.1%)" ;
								gubun_money = 6100000;
								break;
