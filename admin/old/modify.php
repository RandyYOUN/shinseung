...
<label><input type="radio" name="cate_h" id="cate_h" value="SCH" checked> 세무일정</label>
<label><input type="radio" name="cate_h" id="cate_h" value="TRT"> 세무신고</label>
<label><input type="radio" name="cate_h" id="cate_h" value="TIV"> 세무조사</label>
<label><input type="radio" name="cate_h" id="cate_h" value="FOU"> 개원</label>
<label><input type="radio" name="cate_h" id="cate_h" value="LAB"> 노무</label>
<label><input type="radio" name="cate_h" id="cate_h" value="GTX"> 증여세</label>
<label><input type="radio" name="cate_h" id="cate_h" value="INH"> 상속세</label>
<label><input type="radio" name="cate_h" id="cate_h" value="TRA"> 양도세</label>
<label><input type="radio" name="cate_h" id="cate_h" value="QNA"> 상담사례</label>
<label><input type="radio" name="cate_h" id="cate_h" value="THA"> 절세극장</label>
<label><input type="radio" name="cate_h" id="cate_h" value="19T"> 19禁세금</label>
</DIV>
<BR>
...
<input type="file" name="upfile_add" id="upfile_add" class="form-control" />
<br>
<b>현재첨부된 파일</b>
<br/>
<br/>
