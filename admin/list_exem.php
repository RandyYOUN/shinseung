		...
		<div class="content">
			...
			<div class="conwrap">
				...
				<div class="search">
					...
					<input type="box" class="w200p" id="s_str" name="s_str" style="height:39px;">
...
?>
	...
	<input type="hidden" id="page_flag" value="면세사업">
