...
var my_list = $('#my_list').val();
	...
	window.location.href=newURL  + "?g_option="+$('#g_option').val()+"&b_option="+escape($('#b_option').val())+"&s_str="+escape($('#s_str').val())+"&inf_channel="+inf_channel+"&my_list="+my_list;;
});
...
$('#my_list').on('change',function(){
	...
	//var inf_flag = "channeltok";
	var newURL = window.location.protocol + "//" + window.location.host + window.location.pathname;
	window.location.href=newURL  + "?g_option="+$('#g_option').val()+"&b_option="+escape($('#b_option').val())+"&s_str="+escape($('#s_str').val())+"&inf_channel="+escape($('#inf_channel').val())+"&my_list="+my_list;
});
...
$(document).ready(function(){
	...
	function checkit(){
		...
		if(g_option !="" && s_str !=""){
			window.location.href="?g_option="+$('#g_option').val()+"&b_option="+escape($('#b_option').val())+"&s_str="+escape($('#s_str').val())+"&inf_channel="+inf_channel+"&my_list="+my_list;;
		}else{
			alert("검색 조건을 설정해주세요");
			if(g_option ==""){
				$('#s_option').focus();
	...
	$('#excel').click(
			function() {
				...
				var userid="<?= $userid ?>";
				var go_url = "excel_down_simple.php?g_option="+$('#g_option').val()+"&b_option="+escape($('#b_option').val())+"&s_str="+escape($('#s_str').val())+"&inf_channel="+escape($('#inf_channel').val())+"&my_list="+my_list+"&userid="+userid;
	...
	$('#btn_cancel').click(
		function() {
			...
			window.location.href="?b_option="+escape(b_option)+"&g_option="+g_option+"&s_str="+s_str+"&page="+page+"&inf_channel="+inf_channel+"&my_list="+my_list;
		}	
	);
...
function fetchUser()
{
	...
	var action = "select_list_simple2";
	var b_option = $('#b_option').val();
	var g_option = $('#g_option').val();
	var s_str = $('#s_str').val();
	var cst_type = "A1001";//종합소득세
