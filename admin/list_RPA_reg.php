...
?>
	...
	<input type=hidden id="page_flag" value="영업현황">
...
$(document).ready(function(){
	...
	function fetchUser()
	{
		...
		var action = "select_list_reginfo";
		var b_option = $('#b_option').val();
...
function modify_option(obj){ 
	...
	var inf_path = document.getElementById(inf_id).value;
	...
	$.ajax({
		url:"action.php",
		method:"POST",
		data:{action:action,id:id,proc:proc,reguser:reguser,acc_ck:acc_ck, branch:branch, inf_path:inf_path},
		success:function(data){
			console.log(data);
		}
	})
