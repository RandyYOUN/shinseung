...
if($url != "/admin/list_cal2.php" && $url != "/admin/list_cal.php" && $url != "/admin/view_disc.php" ){
	if($jb_login == false){
		$str = "";
...
for (var word in mobileKeyWords) {
	if (navigator.userAgent.match(mobileKeyWords[word]) != null) {
		newurl = window.location.protocol + "//m.taxtok.kr" + window.location.pathname;
		//alert(newurl);
...
//			window.location.href = "m/index.php";
			...
			}else if(url.indexOf("view_disc.php")>0){
...
?>
                            ...
                            <li id="cal"><a href="list_cal.php">계산기</a>
                                <ul class="gnbSub">
									...
									<li id="cal3"><a href="cal_simple_income.php">종소세 세액계산</a></li>
                                </ul>
                            </li>
                            ...
                            <li id="income"><a href="list_RPA_simple.php">종합소득세</a>
                                <ul class="gnbSub">
                                    ...
                                    <li id="reg"><a href="list_RPA_pro.php">전문상담</a></li>
                                    <li id="acc"><a href="list_RPA_acc.php">접수현황</a></li>
                                </ul>
                            </li>
                            <li id="callback"><a href="list_vat_reg.php">부가세</a>
                                <ul class="gnbSub">
                                    <li id="callback_"><a href="list_vat_reg.php">영업현황</a></li>
                                </ul>
                            </li>
