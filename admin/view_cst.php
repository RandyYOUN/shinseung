		...
		<div class="mainbg">
			<div class="content">
				<div class="conwrap">
					...
					<h1>안내문 정보</h1>
				    <div class="btn w100">
    					<button style="cursor:pointer;" class="b_newadd"   name="b_cal_book" id="b_cal_book">장부 바로가기</button>
    				</div>
								...
								<table>
									...
									<thead>
										<tr>
											...
											<th rowspan="2">사업장등록번호</th>
											<th rowspan="2">지급연</th>
											<th rowspan="2">소득귀속연</th>
											<th rowspan="2">지급총액</th>
											<th colspan="3" style="text-align:center;">원천징수세액</th>
						...
						<div class="dashcon">
							<div class="dashboard">
								<table>
									...
									<tbody>
										<tr>
											<th rowspan=2>기납부세액(미리 납부한 세금)</th>
											<td>중간예납세액</td>
											<td><label name="EXI_TAX" id="EXI_TAX"/></label></td>
											<td>중간예납세액 전액</td>
										</tr>
										<tr>
											<td>원천징수세액<br>(인적용역 사업소득)</td>
											<td><label name="WHI_TAX" id="WHI_TAX"/></label></td>
											<td>원천징수세액 전액</td>
										</tr>
										<tr>
											<th rowspan="3">소득공제항목</th>
											<td>국민연금보험료</td>
...
function fetchUser2(flag)
{
	...
	$('#b_cal_book').click(
		function() {
			var request = new Request();
			var id = request.getParameter("id");
			window.location.href="view_acc_cal.php?id="+id;
		}	
	);
