...
.disc_text2{width:100px;height:50px;font-size:20px;text-align:center;padding-top:15px;}
.disc_date{border: 1px solid #e3e3e3;    padding: 5px 15px; width: 220px;font-size: 20px;    height: 50px}
.disc_file{color: #337ab7;
								...
								<table >
									<tbody style="text-align: center;">
										...
										<tr>
											<td>생년월일/연령</td>
											<td colspan=6 style="text-align: left;">
												<input type="date" id="birth" name="birth" class="disc_date">
												&nbsp;&nbsp;
												<label class="disc_text">/</label>
												&nbsp;&nbsp;
												<input type="box" class="disc_text2"  id="age" name="age" numberOnly>
											</td>
											<td>경력(유관업무 경력)</td>
											<td colspan=6 style="text-align: left;">
												<input type="box" class="disc_text2" id="car_year" name="car_year">
												<label class="disc_text">년&nbsp;&nbsp;</label>
												<input type="box" class="disc_text2" id="car_month" name="car_month">
												<label class="disc_text">개월</label>
												
												<input type="checkbox" class="disc_text" id="new_begin" name="new_begin" style="width:20px;margin-left:45px;">
												&nbsp;&nbsp;
												<label class="disc_text">신입</label>
											</td>
										</tr>
										<tr style="background:#90daff29;">
											<td>부서</td>
											<td colspan=6 style="text-align: left;">
												...
												<label for="">선택</label>
												<select name="branch_disc" id ="branch_disc">
											...
											<td>총 직장경력</td>
											<td colspan=6 style="text-align: left;">
												<input type="box" class="disc_text2" id="total_car_year" name="total_car_year">
												<label class="disc_text">년&nbsp;&nbsp;</label>
												<input type="box" class="disc_text2" id="total_car_month" name="total_car_month">
												<label class="disc_text">개월</label>
												
												<input type="checkbox" class="disc_text" style="width:20px;margin-left:45px;" id="total_new_begin" name="total_new_begin">
												&nbsp;&nbsp;
												<label class="disc_text">신입</label>
											</td>
										</tr>
...
전형적 행동유형은 높은점과 낮은점의 조합을 나타내고 있으나 중간형은 4개의 점이 모두 중간영역에 위치한 것이다. 그래프Ⅲ이 중간형이라면 그래프Ⅰ 또는 그래프Ⅱ중 하나를 가지고 해석하는 것이 좋다. 또한 초점을 명료화 한 후 다시 측정하는 것이 더욱 좋다.<BR><BR> 
                									...
                									<tr>
                										<td colspan=2><label class="" id="group_g1" name="group_g1"></label></td>
                										<td colspan=2><label class="" id="group_g2" name="group_g2"></label></td>
                										<td colspan=2><label class="" id="group_g3" name="group_g3"></label></td>
                									</tr>
    											</table>
										...
										<tr style="background:#90daff29;">
											...
											<td colspan=6 style="text-align: left;">
												<div class="selectbox w50">
												<label for="">선택</label>
												<select name="eval_userid" id ="eval_userid">
													<option value="">선택</option>
													<option value="1112">변기영</option>
													<option value="1113">이해옥</option>
													<option value="1114">정혜숙</option>
													<option value="1115">한영순</option>
													<option value="1116">오미자</option>
													<option value="1117">마희숙</option>
													<option value="1118">신정희</option>
													<option value="1119">오선미</option>
													<option value="1120">이찬희</option>
													<option value="1121">최기정</option>
													<option value="1147">노준석</option>
												</select>
												</div>
											</td>
											<td>면접일</td>
											<td colspan=6 style="text-align: left;">
												<input type="date" class="disc_date" id="interview_date" name="interview_date">
											</td>
										</tr>
										<tr>
											<td>최종학력</td>
											<td colspan=6 style="text-align: left;">
												<div class="selectbox w50">
													<label for="">선택</label>
													<select name="final_edu" id ="final_edu" class="w50" onchange="" >
													<option value="">선택</option>
													<option value="H2001">중졸</option>
													<option value="H2002">고졸</option>
													<option value="H2003">전대졸</option>
													<option value="H2004">전대졸예정</option>
													<option value="H2005">대졸</option>
													<option value="H2006">대졸예정</option>
													<option value="H2007">재학중</option>
													<option value="H2008">증퇴</option>
													<option value="H2009">석사</option>
													<option value="H2010">학사</option>
												</select>
												</div>
											</td>
											<td>최종학교명</td>
											<td colspan=6 style="text-align: left;">
												<input type="box" class="disc_text" id="final_school" name="final_school"></label>
											</td>
										</tr>
										<tr style="background:#90daff29;">
											<td>인상</td>
											<td colspan=6 style="text-align: left;">
												<div class="selectbox w50">
													<label for="">선택</label>
													<select name="impression" id ="impression" class="w50" onchange="" >
													<option value="">선택</option>
													<option value="H3001">매우미흡</option>
													<option value="H3002">미흡</option>
													<option value="H3003">평범</option>
													<option value="H3004">우수</option>
													<option value="H3005">적합</option>
												</select>
												</div>
											</td>
											<td>근무 의욕</td>
											<td colspan=6 style="text-align: left;">
												<div class="selectbox w50">
													<label for="">선택</label>
													<select name="desire" id ="desire" class="w50" onchange="" >
													<option value="">선택</option>
													<option value="H3001">매우미흡</option>
													<option value="H3002">미흡</option>
													<option value="H3003">평범</option>
										...
										<tr>
											...
											<td colspan=6 style="text-align: left;">
												<div class="selectbox w50">
													<label for="">선택</label>
													<select name="knowledge" id ="knowledge" class="w50" onchange="" >
													<option value="">선택</option>
													<option value="H3001">매우미흡</option>
													<option value="H3002">미흡</option>
													<option value="H3003">평범</option>
											...
											<td colspan=6 style="text-align: left;">
												<div class="selectbox w50">
													<label for="">선택</label>
													<select name="ability" id ="ability" class="w50" onchange="" >
													<option value="">선택</option>
													<option value="H3001">매우미흡</option>
													<option value="H3002">미흡</option>
													<option value="H3003">평범</option>
										...
										<tr style="background:#90daff29;">
											...
											<td colspan=6 style="text-align: left;">
												<div class="selectbox w50">
													<label for="">선택</label>
													<select name="physical" id ="physical" class="w50" onchange="" >
													<option value="">선택</option>
													<option value="H3001">매우미흡</option>
													<option value="H3002">미흡</option>
													<option value="H3003">평범</option>
											...
											<td colspan=6 style="text-align: left;">
												<div class="selectbox w50">
													<label for="">선택</label>
													<select name="total_eval" id ="total_eval" class="w50" onchange="" >
													<option value="">선택</option>
													<option value="H3001">매우미흡</option>
													<option value="H3002">미흡</option>
													<option value="H3003">평범</option>
										...
										<tr>
											<td>희망 연봉</td>
											<td colspan=6 style="text-align: left;">
												<input type="box" class="disc_text" id="hope_money" name="hope_money" style="width:200px;">
												<label class="disc_text">만원</label>
												<input type="checkbox" class="disc_text" id="include_sev" name="include_sev" style="width:20px;margin-left:45px;">&nbsp;&nbsp;
												<label class="disc_text">퇴직금포함</label>
											...
											<td colspan=6 style="text-align: left;">
												<div class="selectbox w50">
														<label for="">선택</label>
														<select style="width:300px;height:35px;" id="interview_report" name="interview_report" >
														<option value="" >선택</option>
										...
										<tr style="background:#90daff29;">
											...
											<td colspan=13 style="text-align: left;">
												<textarea class="" id="interview_comment" name="interview_comment" style="margin:0px;    width: 874px;height:150px;"></textarea>
											</td>
										</tr>
										...
										<tr style="height:100px;">
											<th>첨부파일</td>
											<td colspan=6 style="text-align:left;" >
												<label id="ING_FILE" name="ING_FILE" style="color: #337ab7;text-decoration: none;"></label>
...
function fetchUser()
{
	...
	$.ajax({
		...
		success:function(data)
		{
			...
			$('#branch_disc').val(data[0].BRANCH);
			$('#car_year').val(data[0].CAR_YEAR);
			$('#car_month').val(data[0].CAR_MONTH);
			$('#total_car_year').val(data[0].TOTAL_CAR_YEAR);
			$('#total_car_month').val(data[0].TOTAL_CAR_MONTH);
			
			if(data[0].NEW_BEGIN == "Y")
				$('#new_begin').prop("checked",true);			
			
			if(data[0].TOTAL_NEW_BEGIN == "Y")
				$('#total_new_begin').prop("checked",true);		
			
			$('#eval_userid').val(data[0].EVAL_USERID);

			$('#interview_date').val(data[0].INTERVIEW_DATE);
			$('#final_edu').val(data[0].FINAL_EDU);
			$('#final_school').val(data[0].FINAL_SCHOOL);
			$('#impression').val(data[0].IMPRESSION);
			$('#desire').val(data[0].DESIRE);
			$('#knowledge').val(data[0].KNOWLEDGE);
			$('#ability').val(data[0].ABILITY);
			$('#physical').val(data[0].PHYSICAL);
			$('#total_eval').val(data[0].TOTAL_EVAL);
			$('#hope_money').val(data[0].HOPE_MONEY);
			$('#interview_report').val(data[0].INTERVIEW_REPORT);
			$('#interview_comment').val(data[0].INTERVIEW_COMMENT);
			$('#progress').val(data[0].PROGRESS);
			$('#reception').val(data[0].RECEPTION);
			...
			for (var i=1;i<file_view_arr.length ;i++ )
			{
				...
				$('#ING_FILE').append("<li id='"+file_real_arr[i]+"'><a href='javascript:down(\""+file_real_arr[i]+"\",\""+file_dir+"\");'>" +file_view_arr[i]+"</a>&nbsp;&nbsp;&nbsp;<b><a href=\"javascript:del2('"+file_real_arr[i]+"','"+file_view_arr[i]+"');\">삭제</a></b></li>");
			}

			$('#file_view_str').val(data[0].FILE_VIEW_STR);
			$('#file_real_str').val(data[0].FILE_REAL_STR);
...
/*파일업로드 : S */
	$('#upfile_add').on('change', function(e){
		...
		var cstname = document.getElementById('username').innerText;
		var mobile = document.getElementById('mobile').innerText;
		var mobile_ = mobile.replace(/-/gi, "")+"/";
		var flag1 = "disc";
		var maxSize = 300 * 1024 * 1024;//200MB
...
function modify(){
	var request = new Request();
		...
		var new_begin = "";
		if($('#new_begin').is(":checked"))
			new_begin = "Y";

		var branch_disc = $('#branch_disc').val();
		var total_car_year = $('#total_car_year').val();
		var total_car_month = $('#total_car_month').val();
		var total_new_begin = "";
		if($('#total_new_begin').is(":checked"))
			total_new_begin = "Y";

		var eval_userid = $('#eval_userid').val();
		var final_edu = $('#final_edu').val();
		var final_school = $('#final_school').val();
		...
		var total_eval = $('#total_eval').val();
		var hope_money = $('#hope_money').val().replace(",","");
		var include_sev = "";
		if($('#include_sev').is(":checked"))
			include_sev = "Y";

		var interview_comment = $('#interview_comment').val();
		var interview_report = $('#interview_report').val();
		...
		if(id !=""){
			...
			//insert page로 위에서 받은 데이터를 넣어준다.
				url:"action.php", 
				method:"POST",
				data:{id:id,userid:userid,action:action,birth:birth,age:age,car_year:car_year,car_month:car_month,new_begin:new_begin, 
					branch_disc:branch_disc, total_car_year:total_car_year, total_car_month:total_car_month, 
					total_new_begin:total_new_begin, eval_userid:eval_userid, final_edu:final_edu, 
					final_school:final_school, impression:impression, desire:desire, knowledge:knowledge, 
					ability:ability, physical:physical, total_eval:total_eval, hope_money:hope_money, 
					include_sev:include_sev, interview_comment:interview_comment, interview_report:interview_report, 
					file_real_str:file_real_str, file_view_str:file_view_str, depid:depid, interview_date :interview_date
					},
				success:function(data){
					...
					if(id != ""){
						window.location.href="view_disc.php?id="+id;			
					}else{
						window.location.href="list_disc.php";			
					}
...
function send_kakao_report(){
	var request = new Request();
	var id = request.getParameter("id");
	var userid = "<?= $userid ?>";
	var add_member = $("#interview_report").val();
