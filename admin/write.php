...
?>
                            ...
                            <li id="income"><a href="list_income.php">종합소득세</a>
                                <ul class="gnbSub">
                                    <li id="income_"><a href="list_income.php">종합소득세</a></li>
                                </ul>
                            </li>
                            ...
                            <li id="RPA"><a href="list_RPA_inc.php">RPA</a>
                                <ul class="gnbSub">
						...
						<tbody>
							...
							<tr>
								...
								<td>
									...
									<br><div name="ING_FILE" id="ING_FILE"></div>
		...
		var now = yyyy+""+mm+""+dd+""+time
		 ...
		 $.each(files, function(key, value)
		 {
		  ...
		  $.ajax({
				 ...
				 url: 'upload_process_news.php?files&now='+time, //file을 저장할 소스 주소입니다.
				 type: 'POST',
				 data: data, //위에서 가공한 data를 전송합니다.
				 cache: false,
				 dataType: 'json',
