...
?>
							...
							<TR>
								<TH>서버 코드번호</TH>
								<TD>
									<input type="box" class="w50" name="svr_code" id="svr_code" >
								</TD>
