...
<body>
    ...
    <div class="wrap">
        ...
        <section class="boardTop">
            <h2 id="page_title"></h2>
           <div class="search"> 
                <select id="b_option" name="b_option" style="width: 105px;">
                ...
                <select id="p_option" name="p_option" style="width: 105px;">
                ...
                <select id="r_option" name="r_option" style="width: 105px;">
                    <option value="" selected>행동유형</option>
