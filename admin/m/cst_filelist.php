    ...
    <section class="stepLast">
        <div class="contents">
            ...
            <ul class="payment">
                ...
                <span style="font-size:16px;">납부금액이 마이너스면 환급금액입니다</span>
            </ul>
...
$id = $_POST["CSTID"];
$path_info = "../upload/2021/";
$path_pay = "../upload/2021/";
			...
			if(mysqli_query($connect,$procedure))
			{
				...
				{					
				    while($row = mysqli_fetch_array($result)){
				        ...
				        $dir_pay = $path_pay.$row["REG_BRANCH_PATH"]."/납부서/".$iconv_cstname.$MOBILE."/";
...
?>
                ...
                <li>
                    <span style="font-size:16px;">위의 납부서를 클릭하여 꼭 확인해주십시오</span>
                </li>
            </ul>
            ...
            <ul class="review">
                <li>
                    <label><input type="radio" id="star1" value="1" name="review"><img src="resources/images/star.png"></label>
                    <label><input type="radio" id="star2" value="2" name="review"><img src="resources/images/star.png"><img
                            src="resources/images/star.png"></label>
                    <label><input type="radio" id="star3" value="3" name="review"><img src="resources/images/star.png"><img src="resources/images/star.png"><img
                            src="resources/images/star.png"></label>
                    <label><input type="radio" id="star4" value="4" name="review"><img src="resources/images/star.png"><img src="resources/images/star.png"><img
                            src="resources/images/star.png"><img src="resources/images/star.png"></label>
                    <label><input type="radio" id="star5" value="5" name="review"><img src="resources/images/star.png"><img src="resources/images/star.png"><img
                            src="resources/images/star.png"><img src="resources/images/star.png"><img src="resources/images/star.png"></label>
                </li>
                <li>
...
function fetchUser()
{
	...
	$.ajax({
		...
		method:"POST",
		dataType:"json",
		data:{action:action,cstid:"<?php echo $_POST["CSTID"]?>"},
