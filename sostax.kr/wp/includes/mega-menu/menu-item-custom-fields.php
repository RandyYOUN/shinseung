		...
		*/
		public static function _filter_walker( $walker ) {
			...
			if ( ! class_exists( $walker ) ) {
				require_once(get_template_directory() . "/includes/mega-menu/walker-nav-menu-edit.php");
			}
...
//require_once(get_template_directory() . "/includes/mega-menu/fields/menu-item-custom-fields.php");
