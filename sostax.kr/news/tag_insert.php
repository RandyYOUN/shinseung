...
$result = @mysql_query("SELECT *, date_format(NEWS_REGDATE,'%d') as reg_dd, left( date_format(NEWS_REGDATE,'%M'),3) as reg_MM , (CASE WHEN IFNULL(IMG_URL ,'') = '' THEN 'http://sostax.kr/y2509g/news/images/tax.png' ELSE IMG_URL END ) AS IMG_URL_  FROM SS_NEWS where ID = $id ORDER BY ID DESC;") or die("SQL error");
			...
			<div class="col-md-9 blog-post" style="float:none; margin:0 auto";>
				<article>
					...
					<div class="post-content">
						<img src="<?php echo $row["IMG_URL_"] ?>" class="img-responsive" alt=""/>
						<p class="excerpt">
...
?>
								...
								<li><a href="#"><?php echo $row["CODE"] ?></a></li>
<?php
}
?>
							</ul>
