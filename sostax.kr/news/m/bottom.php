	...
	<section class="group">
		<div>
			<img src="resources/images/groupK.png">
		</div>
	</section>
	...
	<footer>
		...
		<ul>
			...
			<li>서울특별시 강남구 테헤란로4길 6, 2층 214, 215호 / 02-3452-1134 </li>
...
//세미나영상
$(".video div ul li a").click(function() {	
	var title = $(this).text();
	$(".modalVideo a span").text(title);
	$(".modalVideo").fadeIn();
	$(".mask").fadeIn();	
	$('.modalVideo iframe').attr('src',$(this).attr('data-url'));	
	});

$(".modalVideo .close, .mask").click(function() {
	$(".modalVideo").fadeOut();
	$(".mask").fadeOut();
